...
class Interaction(Base):
    ...
    # New fields for auditability and budgeting
    priority = Column(String(50), default="normal")  # "urgent", "normal", "deferred"
    llm_tokens_used = Column(Integer, default=0)     # actual tokens consumed
    processing_status = Column(
        String(50), default="pending"
    )  # "pending", "in_progress", "completed", "failed"

    # Structured error log (JSONB list of error events)
    error_log = Column(JSONB, default=list)
